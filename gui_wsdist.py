...
# Build the window.
window = sg.Window(f"Kastra FFXI Damage Simulator (2023 March 07)",layout,size=(700,930) if h>930 else (700+500,600),resizable=True,alpha_channel=1.0,finalize=True,no_titlebar=False,ttk_theme=random_style)
