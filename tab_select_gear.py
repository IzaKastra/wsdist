...
gear_tab = [
  [sg.Column([
    [sg.Push(),sg.Button("Main",font=font_choice,pad=(0,0),border_width=1,size=(8,3),key="display main"),sg.Button("Sub",font=font_choice,pad=(0,0),border_width=1,size=(8,3),key="display sub"),sg.Button("---",font=font_choice,pad=(0,0),border_width=1,size=(8,3),key="display ---"),sg.Button("Ammo",font=font_choice,pad=(0,0),border_width=1,size=(8,3),key="display ammo"),sg.Push()],
    [sg.Push(),sg.Button("Head",font=font_choice,pad=(0,0),border_width=1,size=(8,3),key="display head"),sg.Button("Neck",font=font_choice,pad=(0,0),border_width=1,size=(8,3),key="display neck"),sg.Button("Ear1",font=font_choice,pad=(0,0),border_width=1,size=(8,3),key="display ear1"),sg.Button("Ear2",font=font_choice,pad=(0,0),border_width=1,size=(8,3),key="display ear2"),sg.Push()],
    [sg.Push(),sg.Button("Body",font=font_choice,pad=(0,0),border_width=1,size=(8,3),key="display body"),sg.Button("Hands",font=font_choice,pad=(0,0),border_width=1,size=(8,3),key="display hands"),sg.Button("Ring1",font=font_choice,pad=(0,0),border_width=1,size=(8,3),key="display ring1"),sg.Button("Ring2",font=font_choice,pad=(0,0),border_width=1,size=(8,3),key="display ring2"),sg.Push()],
