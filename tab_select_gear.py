...
odyssey_rank_thing = [sg.Text("Odyssey Rank:",size=(15,1),font=font_choice,),sg.Combo(values=["15","20","25","30"], default_value="30", readonly=True, key="odyssey rank",size=(10,1),font=font_choice,tooltip="Auto-select Odyssey gear with this rank.",disabled=False,enable_events=False)]
gear_tab = [
  [sg.Column([
